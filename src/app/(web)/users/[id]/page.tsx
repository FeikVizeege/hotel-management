...
const UserDetails = (props: { params: { id: string } }) => {
    ...
    const reviewSubmitHandler = async () => {
        ...
        if (!roomId) return toast.error("Room Id not provided");
    ...
    return (
        <div className="container mx-auto px-2 md:px-4 py-10">
            <div className="grid md:grid-cols-12 gap-10">
                <div className="hidden md:block md:col-span-4 lg:col-span-3 shadow-lg h-fit sticky top-10 bg-gray-200 text-black rounded-lg px-6 py-4">
                ...
                <div className="md:col-span-8 lg:col-span-9">
                    ...
                    {currentNav === "amount" ? (
                        userBooking && <Chart userBooking={userBooking} />
                    ) : (
                        <></>
                    )}
                </div>
